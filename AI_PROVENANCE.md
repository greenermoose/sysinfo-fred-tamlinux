...
| **Marketplace cache security fix** | `v1.1.2` unreleased | Codex CLI (`codex 0.155.1`, `gpt-6-sol`) | Removed shared scratch cache paths, added private runtime storage with descriptor-relative no-follow atomic writes and checked reads, and added cache attack tests; updated renamed repository links. |
